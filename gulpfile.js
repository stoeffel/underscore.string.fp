var gulp = require('gulp-param')(require('gulp'), process.argv),
  ...
  SRC = 'index.js',
  DEST = 'dist',
  SRC_COMPILED = 'underscore.string.fp.js',
  MIN_FILE = 'underscore.string.fp.min.js',
  TEST_SUITES = ['test/test.html', 'test/test_standalone.html', 'test/test_ramda.html'],
...
gulp.task('browserify', function() {
  return gulp.src(SRC)
    ...
    .pipe(rename('underscore.string.fp.js'))
    .pipe(gulp.dest(DEST));
});
